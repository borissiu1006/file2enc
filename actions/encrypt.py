...
ENGINES = {
    ...
    "6": ("sig",       "Signature            — ! Fun engine -- Use your signature as the key"),
    "7": ("chameleon", "Chameleon            — ! Fun engine --Hide file inside a cover image"),
}
...
def action_encrypt():
    ...
    print(f"  {c('For production use, do not use experimental/fun engines [5-7]:', DIM)}\n")
